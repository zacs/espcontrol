...
export const GENERATED_ICON_NAMES: readonly string[] = [
    ...
    "Air Purifier Off", "Airplane", "Alarm", "Alarm Light", "Alert", "Alert Octagon",
    ...
    "Delete Outline", "Desk", "Desk Lamp", "Desk Lamp Off", "Desk Lamp On", "Dishwasher",
    ...
    "Information", "Iron", "Kettle", "Key", "Lamp", "Lamp Outline",
    ...
    "Lightbulb Auto Outline", "Lightbulb Group", "Lightbulb Group Outline", "Lightbulb Night", "Lightbulb Night Outline", "Lightbulb Off",
    ...
    "Solar Panel", "Solar Panel Large", "Solar Power", "Solar Power Variant", "Speaker", "Speaker Multiple",
    "Speaker Wireless", "Speaker Off", "Speaker Pause", "Speaker Play", "Spotlight", "Spotlight Beam",
    "Sprinkler", "Sprinkler Variant", "Stop", "String Lights", "String Lights Off", "Stove",
    ...
    "Thermostat Auto", "Thermometer Water", "Timer", "Toilet", "Track Light", "Track Light Off",
